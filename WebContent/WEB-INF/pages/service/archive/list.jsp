...
<body>
	...
	<form action="${ctx }/service/archive/list" method="get">
				...
				<c:forEach var="service" items="${page.content }">
					<tr>
						...
						<td class="list_data_op">
							<img onclick="window.location.href='${ctx}/service/archive?id=${service.id }'" title="查看"
								src="${ctx}/static/images/bt_detail.gif" class="op_button" />
						</td>
					</tr>
				</c:forEach>
			</table>
